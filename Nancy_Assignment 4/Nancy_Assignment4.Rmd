...
Using the dataframe “state_prime_acc”, draw an
unstacked bar plot showing how the accuracy (Y)
varies as a function of the four prime conditions
(X), such that the bars are color coded by the
reported state (see expected plot below).
Hint: use position = “dodge” for unstacking the
bars
```{r}
state_prime_acc %>%
